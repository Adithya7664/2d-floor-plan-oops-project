...
// String[] names = new String[as.panelroom.size()];
// int i = 0;
// for (JPanel panelroom : as.panelroom) {
...
// boolean b = false;
// int i = 0;
// for (JPanel existingPanel : as.panelroom) {
...
// as.panelroom.add(newPanel); // Add the new panel if no overlap
// //
// rs = new roomsave(newPanel.getX(), newPanel.getY(), newPanel.getWidth(),
// newPanel.getHeight(),
...
// oos.writeObject(as.roomsave);
// savePanels(file, as.roomsave);
